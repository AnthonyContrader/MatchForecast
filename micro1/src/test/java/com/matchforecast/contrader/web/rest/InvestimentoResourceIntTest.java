...
import com.matchforecast.contrader.repository.InvestimentoRepository;
import com.matchforecast.contrader.service.InvestimentoService;
import com.matchforecast.contrader.service.dto.InvestimentoDTO;
import com.matchforecast.contrader.service.mapper.InvestimentoMapper;
...
public class InvestimentoResourceIntTest {
    ...
    private static final Integer DEFAULT_IDUSER = 1;
    private static final Integer UPDATED_IDUSER = 2;
    ...
    public void createInvestimento() throws Exception {
        ...
        assertThat(testInvestimento.getIduser()).isEqualTo(DEFAULT_IDUSER);
    }
    ...
    public void updateInvestimento() throws Exception {
        ...
        assertThat(testInvestimento.getIduser()).isEqualTo(UPDATED_IDUSER);
    }
