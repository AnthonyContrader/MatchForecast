...
public class InvestimentoConverter extends AbstractConverter<Investimento,InvestimentoDTO>  {
	...
	public Investimento toEntity(InvestimentoDTO investimentoDTO) {
		...
		if (investimentoDTO != null) {
			investimento = new Investimento (investimentoDTO.getId(),investimentoDTO.getUser(),investimentoDTO.getSchedina(),investimentoDTO.getBudget(),investimentoDTO.getDurata(),investimentoDTO.getFRischio());			
		}
		return investimento;
	}
	...
	public InvestimentoDTO toDTO(Investimento investimento) {
		...
		if (investimento != null) {
		    investimentoDTO = new InvestimentoDTO(investimento.getId(),investimento.getUser(),investimento.getSchedina(),investimento.getBudget(),investimento.getDurata(),investimento.getFRischio());
